...
every before/after pair is written to Step2_Applied_ICPMS_TAPPOWNED_2026-08-27.csv (W4), so any edit is
...
import tapp_segment
import icp_step2_edits

DATE = "2026-08-27"
SHORT = {"LA-MC-ICPMS_TAPP":"LA-MC","LA-MC-ICPMS_UPb_TAPP":"LA-MC_UPb","LA-Q-ICP-MS_TAPP":"LA-Q",
         "LA-Q-ICP-MS_UPb_TAPP":"LA-Q_UPb","LA-SF-ICP-MS_TAPP":"LA-SF","LA-SF-ICP-MS_UPb_TAPP":"LA-SF_UPb",
         "Solution_MC-ICP-MS_TAPP":"Sol-MC","Solution_Q-ICP-MS_TAPP":"Sol-Q","Solution_SF-ICP-MS_TAPP":"Sol-SF"}

EDITS = {}
for mod in (icp_step2_edits,):
...
def main(apply=False):
    ...
    for r in csv.DictReader(open(os.path.join(ROOT,"Claude Skills for TAPP","analysis",
                            "Step1_Routing_ICPMS_TAPPOWNED_2026-08-27.csv"),newline="",encoding="utf-8-sig")):
    ...
    lp = os.path.join(ROOT,"Claude Skills for TAPP","analysis","Step2_Applied_ICPMS_TAPPOWNED_2026-08-27.csv")
