...
|---|---|---|---|
| `EPMA_Procedure_Registration_Mockup.html` | `EPMA_TAPP_v75.csv` | 30 — Neuman et al. 2025 | WDS Mapping |
| `EPMA_Point_Analysis_Mockup.html` | `EPMA_TAPP_v75.csv` | 19 — Ma et al. 2017 | WDS Point Analysis |
