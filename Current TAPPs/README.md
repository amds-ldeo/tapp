...
- `EPMA_TAPP_v68.csv`
- `LA-MC-ICPMS_TAPP_v75.csv`
- `LA-MC-ICPMS_UPb_TAPP_v74.csv`
- `LA-Q-ICP-MS_TAPP_v76.csv`
- `LA-Q-ICP-MS_UPb_TAPP_v76.csv`
- `LA-SF-ICP-MS_TAPP_v73.csv`
- `LA-SF-ICP-MS_UPb_TAPP_v74.csv`
- `Lab-XCT_TAPP_v39.csv`
- `SEM_Composition_TAPP_v64.csv`
- `SEM_FIBSEM_TAPP_v32.csv`
- `SEM_Imaging_TAPP_v31.csv`
- `SEM_TAPP_v65.csv`
- `Solution_MC-ICP-MS_TAPP_v75.csv`
- `Solution_Q-ICP-MS_TAPP_v79.csv`
- `Solution_SF-ICP-MS_TAPP_v75.csv`
- `TEM_TAPP_v51.csv`
