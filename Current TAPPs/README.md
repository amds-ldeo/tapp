...
- `EPMA_TAPP_v57.csv`
- `LA-MC-ICPMS_TAPP_v64.csv`
- `LA-MC-ICPMS_UPb_TAPP_v64.csv`
- `LA-Q-ICP-MS_TAPP_v67.csv`
- `LA-Q-ICP-MS_UPb_TAPP_v67.csv`
- `LA-SF-ICP-MS_TAPP_v64.csv`
- `LA-SF-ICP-MS_UPb_TAPP_v65.csv`
- `Lab-XCT_TAPP_v35.csv`
- `SEM_Composition_TAPP_v55.csv`
